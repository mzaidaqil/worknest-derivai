      ...
      <div className="content">
        ...
        <header className="topbar">
          <div className="search">
            ...
            <input
              type="text"
              placeholder="Search policies, requests, documents..."
              aria-label="Search"
            />
          </div>
        ...
        <div className="banner">
          ...
          Privacy &amp; Human Oversight: Sensitive changes require HR approval.
          AI drafts are for assistance only.
        </div>
